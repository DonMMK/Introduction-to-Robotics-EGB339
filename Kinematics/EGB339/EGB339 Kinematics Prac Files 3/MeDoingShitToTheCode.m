...
%else
    ...
    while (i < 4)
        ...
        lifttarget = [9.25 theta2 -2.75 theta4 theta5]
        dobot_sim.setJointPositions(lifttarget);
        
        pause(1);
        
        lifttarget = [19 theta2 -5.5 theta4 theta5]
        dobot_sim.setJointPositions(lifttarget);
        
        pause(1);
        
        lifttarget = [28.25 theta2 -8.25 theta4 theta5]
        dobot_sim.setJointPositions(lifttarget);
        ...
        newtarget = [theta1 0 theta3/2 theta4 theta5]
        ...
        % Robot moves:
        newtarget = [theta1 theta2 theta3/2  theta4 theta5]
        dobot_sim.setJointPositions(newtarget);
